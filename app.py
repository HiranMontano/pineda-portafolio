...
CSS = """
<style>
@import url('https://fonts.googleapis.com/css2?family=Archivo+Black&family=Bebas+Neue&family=Anton&family=Space+Mono:wght@400;700&display=swap');
...
.stApp {
  background:
    ...
    linear-gradient(135deg,#111014 0%,#1e1a20 48%,#0c0b0e 100%) !important;
...
.bio-card {
  ...
  min-height: 520px;
  border: 2px solid var(--paper);
  background: linear-gradient(0deg,rgba(236,13,13,.25),rgba(0,0,0,.1)), linear-gradient(135deg,var(--brick),var(--charcoal));
...
.project-cover {
  min-height: 520px;
  border: 2px solid var(--paper);
  background: linear-gradient(rgba(236,13,13,.15),rgba(0,0,0,.25)), linear-gradient(135deg,#4e2b36,#151319);
...
v0, v1, v2 = VIDEOS[0], VIDEOS[1], VIDEOS[2]
...
<div class="page">
  ...
  <section id="bio" class="section">
    <div class="bio-copy reveal">
      ...
      <p class="bio-text">
        <strong>Convierto tu alma en música.</strong> Soy productor musical, beatmaker y músico enfocado en transformar
        ideas, emociones y visiones artísticas en proyectos con identidad real. Me muevo entre lo orgánico y lo urbano,
        mezclando influencias del jazz, el hip hop y otros lenguajes modernos para crear sonoridades vivas, profundas y
        diferentes. Busco que cada proyecto tenga carácter propio, que conecte emocionalmente y que haga sentir al artista
        realmente representado por su música.
      </p>
      <p class="bio-text">
        Además de la producción, trabajo como arreglista, bajista de sesión y músico en vivo, desarrollando desde grooves
        y armonías hasta estructuras y conceptos completos para cada proyecto. Mi enfoque está en entender la esencia de
        cada artista y convertirla en una experiencia sonora auténtica, cuidando tanto la emoción como los detalles
  ...
  <section id="videos" class="section">
    ...
    <div class="video-layout reveal">
      <a class="video-card video-main" href="{v0['url']}" target="_blank" rel="noopener">
        <img src="{v0['thumb']}" alt="{v0['title']}" class="video-thumb"/>
        <div class="play">&#9654;</div>
      ...
      <div class="video-stack">
        <a class="video-card" href="{v1['url']}" target="_blank" rel="noopener">
          <img src="{v1['thumb']}" alt="{v1['title']}" class="video-thumb"/>
          <div class="play">&#9654;</div>
          <div class="video-caption">
            <h3>{v1['title']}</h3>
            <span>{v1['sub']}</span>
        ...
        <a class="video-card" href="{v2['url']}" target="_blank" rel="noopener">
          <img src="{v2['thumb']}" alt="{v2['title']}" class="video-thumb"/>
          <div class="play">&#9654;</div>
          <div class="video-caption">
            <h3>{v2['title']}</h3>
            <span>{v2['sub']}</span>
  ...
  <section id="proyecto" class="section">
    ...
    <div class="project-grid">
      ...
      <div class="project-copy reveal">
        <p class="manifesto">
          Mi proyecto personal nace de la unión entre el <strong>hip-hop old school</strong>, el sampling, el bajo
          eléctrico y la sensibilidad armónica del jazz. Es un espacio para contar historias desde el groove: beats con
          textura, melodías oscuras, baterías con peso y una estética cruda, directa y emocional.
        </p>
        <p class="manifesto">
          Más que producir por producir, busco construir una identidad completa: portada, sonido, narrativa, referencias,
          arreglos e intención. Cada canción tiene que sentirse como una escena, una calle, una noche o una memoria.
        </p>
